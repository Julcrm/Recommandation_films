...
if st.session_state.page == "accueil":
    ...
    st.markdown("""
        ...
        <div style="margin-bottom: 15px;">Grâce à une analyse approfondie des données des films du monde entier et d’un algorithme puissant, ce site vous proposera des films similaires à vos coups de cœur</div>
        <div style="margin-bottom: 15px;">Je mise sur la transparence de mes choix et de l'algorithme. Vous pourrez donc retrouver tous mes critères ainsi que des graphiques interactifs illustrant les données cinématographiques du monde entier sur l’onglet <span style="text-decoration: underline;"> visualisations </span> </div>
        ...
        <p style="margin-top: 20px;">Que vous soyez amateur de blockbusters, nostalgique des films des années 90, ou fan de cinéma d'auteur, cet outil est là pour enrichir votre univers cinématographique ! </p>
